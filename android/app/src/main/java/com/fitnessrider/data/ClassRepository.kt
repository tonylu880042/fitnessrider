            ...
            val demo = WorkoutClass(
                ...
                segments = listOf(
                    WorkoutSegment(
                        ...
                        intensityZone = 2,
                        cues = listOf(
                            WorkoutCue(offsetMs = 0, posture = PostureType.SEATED_FLAT, targetRpm = 85, resistanceLevel = "LEVEL 3", message = "坐姿平路，輕鬆踩踏建立踏頻節奏"),
                            WorkoutCue(offsetMs = 120_000, posture = PostureType.STANDING_FLAT, targetRpm = 80, resistanceLevel = "LEVEL 4", message = "起立站姿平路，拉長呼吸與核心穩定")
                        )
                    ),
                    WorkoutSegment(
                        id = UUID.randomUUID().toString(),
                        ...
                        intensityZone = 4,
                        cues = listOf(
                            WorkoutCue(offsetMs = 0, posture = PostureType.SEATED_CLIMB, targetRpm = 68, resistanceLevel = "LEVEL 6", message = "加兩圈重阻力，深沉坐姿爬坡"),
                            WorkoutCue(offsetMs = 180_000, posture = PostureType.STANDING_CLIMB, targetRpm = 60, resistanceLevel = "LEVEL 8", message = "起立站姿重爬坡，用全身重量下壓踩動！")
                        )
                    ),
                    WorkoutSegment(
                        id = UUID.randomUUID().toString(),
                        ...
                        intensityZone = 5,
                        cues = listOf(
                            WorkoutCue(offsetMs = 0, posture = PostureType.SEATED_FLAT, targetRpm = 90, resistanceLevel = "LEVEL 4", message = "預備區間，呼吸吸飽加速中"),
                            WorkoutCue(offsetMs = 60_000, posture = PostureType.SPRINT, targetRpm = 115, resistanceLevel = "LEVEL 5", message = "🔥 全力衝刺 30 秒！踩破 110 RPM！"),
                            WorkoutCue(offsetMs = 150_000, posture = PostureType.RECOVERY, targetRpm = 75, resistanceLevel = "LEVEL 2", message = "放鬆深呼吸，緩和踩踏")
                        )
                    )
                )
            )
