export default function Faq() {
  const faqs = [
    {
      q: '什麼是「30 天全功能免費試用」？需要先綁定信用卡嗎？',
      a: '不需要！當您在 iPad 或 Android 平板首次下載並啟動 FitnessRider 時，系統即自動自起算日起提供完整 30 天的全功能免費試用期。試用期間無任何功能閹割：包含課表無限編排、波形 BPM 自動分析、0.7x~1.3x 變速不變調、1~3 秒等能量平滑 Crossfade、3-2-1 倒數音效、車把觸覺震動回饋以及 .riderclass 課表包匯出匯入皆全面開放。試用期滿後若未訂閱，系統僅提示輸入授權碼或進行商店訂閱，絕不暗中扣款。',
    },
    {
