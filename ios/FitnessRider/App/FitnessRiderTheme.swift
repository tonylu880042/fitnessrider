...
public enum FitnessRiderTheme {
    ...
    public static let zone1 = Color(red: 66 / 255.0, green: 153 / 255.0, blue: 225 / 255.0)  // Blue - Recovery
    public static let zone2 = Color(red: 72 / 255.0, green: 187 / 255.0, blue: 120 / 255.0)  // Green - Aerobic
    public static let zone3 = Color(red: 236 / 255.0, green: 201 / 255.0, blue: 75 / 255.0)  // Yellow - Tempo
    public static let zone4 = Color(red: 237 / 255.0, green: 137 / 255.0, blue: 54 / 255.0)  // Orange - Threshold
    public static let zone5 = Color(red: 229 / 255.0, green: 62 / 255.0, blue: 62 / 255.0)   // Red - Max Effort
